...
{ crontab -l -u jaapz; echo '*/2 * * * * unison -auto -batch -confirmbigdel=false -sshargs "-i /home/jaapz/.ssh/id_rsa" ~/synced ssh://broekhuizen.nu//home/jaapz/backup'; } | crontab -u jaapz -
